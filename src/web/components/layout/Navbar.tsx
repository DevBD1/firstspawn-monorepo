    ...
    <nav className="sticky top-0 z-[100] border-b-4 border-black bg-navbar-bg/95 px-4 py-3 backdrop-blur-md sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <Link href={`/${lang}`} className="group flex items-center gap-3" onClick={() => setIsOpen(false)}>
            <div className="flex h-10 w-10 items-center justify-center bg-primary text-xl text-white font-display shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all group-hover:translate-x-0.5 group-hover:translate-y-0.5 group-hover:shadow-none border-2 border-black">
              F
            </div>
