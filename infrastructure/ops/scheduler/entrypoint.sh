...
rollup_schedule="${SCHEDULE_PROBE_ROLLUPS:-*/10 * * * *}"
retention_schedule="${SCHEDULE_ROLLUP_RETENTION:-30 2 * * *}"
...
${rollup_schedule} /work/infrastructure/ops/scheduler/job-runner.sh probe-rollups bash /work/infrastructure/ops/cron/refresh-probe-rollups.sh
${retention_schedule} /work/infrastructure/ops/scheduler/job-runner.sh probe-retention /work/infrastructure/ops/cron/aggregate-retention.sh
...
echo "scheduler_retention=${retention_schedule}"
