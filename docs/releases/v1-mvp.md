...
>
> This file is **canonical for v1 (MVP) feature scope** — what ships, what does
> not, acceptance criteria, and the launch gate. It is **subordinate to
> `PRODUCT.md`**: where this scope and a product principle conflict, `PRODUCT.md`
> wins and this file is corrected. Durable vision, principles, personas, and
> governance live in `PRODUCT.md`.
>
> Section numbering continues at §2 because §1 (Product Direction & Core
> Principles) lives in `PRODUCT.md`; the numbers are preserved so existing
> cross-references keep resolving.
>
> **Amendment 2026-06-24** (design review, via the `PRODUCT.md` governance
> production-blocker clause; the 2026-06-22 freeze otherwise stands):
>
